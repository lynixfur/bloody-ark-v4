        ...
        <>
                                ...
                                <div>
                                    <div className="container flex flex-col items-center py-12 sm:py-24">
                                        <div className="w-full mt-5 justify-center items-center flex-col mb-5 sm:mb-10">
                                            ...
                                            <span><i className="fa-solid fa-server mr-4 mb-3" /><br />Server Manager</span>
                                            </h1>
                                        </div>
                                    </div>
                                </div>
            ...
            {!isEditing && <div className="p-5">
                <div className="flex">
                    ...
                    <button type="button" className="ml-3 text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-0.5 text-center mr-2 mb-2"><i className="fa-solid fa-server"></i> Create Server</button>
                </div>
                ...
                >
                    <tbody>
                        ...
                        {data?.servers?.map((server: any) => (
                            <tr key={server?.id} className="focus:outline-none h-12 border-t border-b-[2px] border-bgray-bg bg-bgray-secondary hover:bg-bgray-overlay transition-colors">
                                ...
                                <td className="pl-5">
                                    <i className={"fa-solid fa-server m-1 my-auto text-xl text-gray-500"} /> {server?.name}
                                </td>
                                <td className="pl-5">
                                    {server?.map}
                                </td>
                                <td className="pl-5 ">
                                    <span className="bg-bgray-dropdown border border-zinc-700 text-zinc-300 font-bold mr-2 px-2.5 py-0.5 rounded-full">{server?.cluster.strId}</span>
                                </td>
                                <td className="pl-5">
                                    {server?.game == "ArkASA" ? <img src="/asa.webp" className="h-7"/> : <img src="/ark.webp" className="h-5"/>}
                                </td>
                                <td className="pl-5">
                                    {server?.visible ? <i className="fa-solid fa-eye"></i>: <i className="fa-solid fa-eye-slash"></i>}
                                </td>
                                <td className="pl-5">
                                    {server?.online ?  <i className={"fa-solid fa-circle text-green-600"}/> : <i className={"fa-solid fa-circle text-red-600"}/>}
                                </td>
