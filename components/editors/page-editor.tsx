                    ...
                    <tbody>
                        ...
                        {data?.pages?.map((page: any) => (
                            <tr key={page?.id} className="focus:outline-none h-12 border-t border-b-[2px] border-bgray-bg bg-bgray-secondary hover:bg-bgray-overlay transition-colors">
                                ...
                                <td className="pl-5">
                                    {page?.game == "ArkASA" ? <img src="/asa.webp" className="h-7"/> : <img src="/ark.webp" className="h-5"/>}
                                </td>
                                <td className="pl-5">
                                    {page?.visible ? <i className="fa-solid fa-eye"></i>: <i className="fa-solid fa-eye-slash"></i>}
                                </td>
